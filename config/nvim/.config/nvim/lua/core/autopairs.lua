...
M.setup = function()
  ...
  if package.loaded["compe"] then
    require("nvim-autopairs.completion.compe").setup {
      map_cr = neo.builtin.autopairs.map_cr,
      map_complete = neo.builtin.autopairs.map_complete,
    }
  end

  autopairs.setup {
    check_ts = neo.builtin.autopairs.check_ts,
    ts_config = neo.builtin.autopairs.ts_config,
  }
  ...
  if neo.builtin.autopairs.on_config_done then
    neo.builtin.autopairs.on_config_done(autopairs)
  end
end
