...
M.setup = function()
  vim.g.vsnip_snippet_dir = neo.vsnip_dir

  local compe = require "compe"

  compe.setup(neo.builtin.compe)
  ...
  keymap.load(neo.builtin.compe.keymap.values, neo.builtin.compe.keymap.opts)
  ...
  if neo.builtin.compe.on_config_done then
    neo.builtin.compe.on_config_done(compe)
  end
end
