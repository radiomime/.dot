print('lua plugins script -- processing')

-- Credit below to lukas-reineke. clean this and see what I need
-- TODO: transfer plugins from Plug to packer if I feel like
-- TODO: Plug in this format might work.

print('lua plugins script -- currently empty')
