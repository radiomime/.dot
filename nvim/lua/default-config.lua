-- TODO: what is in ~/.local/share/lunarvim/site
-- TODO: what is in ~/.local/share/lunarvim/lvim
-- TODO: or rather, ~/.local/share/nvim/*
-- TODO: site and crap probably not needed, not sure what it is
    ...
    cmake = {
        ...
        lsp = {
            ...
            setup = {
                cmd = {
                    DATA_PATH
                        .. "/lspinstall/cmake/venv/bin/cmake-language-server",
                },
            },
        },
    },
    ...
    elixir = {
        ...
        lsp = {
            ...
            setup = {
                cmd = {
                    DATA_PATH
                        .. "/lspinstall/elixir/elixir-ls/language_server.sh",
                },
            },
        },
    },
    elm = {
        ...
        lsp = {
            ...
            setup = {
                cmd = {
                    DATA_PATH
                        .. "/lspinstall/elm/node_modules/.bin/elm-language-server",
                },
                -- init_options = {
                ...
                settings = {
                    Lua = {
                        ...
                        workspace = {
                            ...
                            library = {
                                [vim.fn.expand("~/.local/share/nvim/nvim/lua")] = true,
    ...
    php = {
        ...
        lsp = {
            ...
            setup = {
                cmd = {
                    DATA_PATH
                        .. "/lspinstall/php/node_modules/.bin/intelephense",
                    "--stdio",
                },
                filetypes = { "php", "phtml" },
                settings = {
    ...
    puppet = {
        ...
        lsp = {
            ...
            setup = {
                cmd = {
                    DATA_PATH
                        .. "/lspinstall/puppet/puppet-editor-services/puppet-languageserver",
                    "--stdio",
                },
            },
        },
    ...
    svelte = {
        ...
        lsp = {
            ...
            setup = {
                cmd = {
                    DATA_PATH
                        .. "/lspinstall/svelte/node_modules/.bin/svelteserver",
                    "--stdio",
                },
            },
        },
    ...
    vim = {
        ...
        lsp = {
            ...
            setup = {
                cmd = {
                    DATA_PATH
                        .. "/lspinstall/vim/node_modules/.bin/vim-language-server",
                    "--stdio",
                },
            },
        },
...
-- NOTE: which-key should be first because it defines neo.builtin.which_key.mappings
