...
M.setup = function()
    ...
    which_key.setup(neo.builtin.which_key.setup)

    local opts = neo.builtin.which_key.opts
    local vopts = neo.builtin.which_key.vopts

    local mappings = neo.builtin.which_key.mappings
    local vmappings = neo.builtin.which_key.vmappings

    which_key.register(mappings, opts)
    which_key.register(vmappings, vopts)

    if neo.builtin.which_key.on_config_done then
        neo.builtin.which_key.on_config_done(which_key)
    end
end
